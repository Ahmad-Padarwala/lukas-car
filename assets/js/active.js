...
(function($) {
    ...
    jQuery(document).ready(function($) {
        ...
        $('.main-menu.nav').slicknav({
            ...
            closeOnClick: true,
            removeClasses: true,
            closedSymbol: '<ion-icon name="add-outline"></ion-icon>',
            openedSymbol: '<ion-icon name="remove-outline"></ion-icon>'
        });
        ...
        $(".slider-content-active").slick({
            ...
            dots: true,
            adaptiveHeight: true,
            nextArrow: '<button class="slick-next"><ion-icon name="chevron-forward-outline"></ion-icon></button>',
            prevArrow: '<button class="slick-prev"><ion-icon name="chevron-back-outline"></ion-icon></button>',
            responsive: [{
                breakpoint: 992,
                settings: {
                    arrows: false
